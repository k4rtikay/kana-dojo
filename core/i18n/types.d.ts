 ...
 */
export type Namespace = 'common' | 'navigation' | 'kana' | 'kanji' | 'vocabulary' | 'achievements' | 'statistics' | 'settings' | 'errors' | 'menuInfo' | 'blog' | 'metadata' | 'welcome' | 'experiments' | 'legal';
